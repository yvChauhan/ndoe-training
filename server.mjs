...
const links = [
    { link: "/", label: "Home", role:''},
    { link: "/products", label: "Products", role: 'user'},
    { link: "/about-us", label: "About Us", role: 'user'},
...
const LABELS = {
    HOME: {key:'home', value:'Home'},
    ABOUT_US: {key:'about-us', value:'About Us'},
    PRODUCTS: {key:'products', value:'Products'},
    LOGIN: {key:'login', value:'Login'},
    ORDER_CONFIRMATION: {key:'order-confirmation', value:'Order Confirmation'},
    ADD_PRODUCT: {key:'add-product', value:'Add Product'},
    CART: {key:'cart', value:'Cart'},
    PDP: {key:'product-detail', value: 'Products Details Page', role: 'detail'}
}
